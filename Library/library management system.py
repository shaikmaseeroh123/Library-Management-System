...
# Variables
lf_bg = 'Lavender'  # Left Frame Background Color
rtf_bg = 'MediumOrchid'  # Right Top Frame Background Color
rbf_bg = 'Purple'  # Right Bottom Frame Background Color
btn_hlb_bg = 'SlateBlue'  # Background color for Head Labels and Buttons
